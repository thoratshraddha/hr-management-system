...
public class ProductTypeForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText(" Product Type Name");
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        if(btntext.equals("Save")){ //Insert
            ...
            Messages.showInfo("ProductType Information is Saved Successfully...", "Success");        
        }else{ //Update
            db.execute("Update ProductType set ProductTypeName=? where ProductTypeName=?",name,oldname);
            Messages.showInfo("ProductType Information is Updated Successfully...", "Success");        
        }
        db.fillTable(table1, "select * from ProductType");
