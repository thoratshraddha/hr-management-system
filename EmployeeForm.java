...
public class EmployeeForm extends javax.swing.JFrame {
    ...
    public EmployeeForm() {
        ...
        db.fillTable(table1, "select * from employee");
        db.enableSearch(table1, "select * from employee", cmbfield, txtsearch);
    ...
    private void initComponents() {
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "EmpNo", "EmpName", "EmpAddress", "MobileNo", "BirthDate", "AcBalance"
            }
        ));
        ...
        cmbfield.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "EmpNo", "EmpName", "EmpAddress" }));
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        //Apply Validation
        if(custname.equals("")){
              Messages.showWarning("Employee Name Cannot be left empty", "Input Error");
              txtname.requestFocus();
              return;
          }
          if(custaddress.equals("")){
              Messages.showWarning("Employee Address cannot be empty", "Input Error");
        ...
        if(btntext.equals("Save")){ //Insert
            db.execute("Insert into employee values(?,?,?,?,?,?)",custno,custname,custaddress,mobile,bdate,acbal);
            db.updateID("EmpNo");
            Messages.showInfo("employee Information is Saved Successfully...", "Success");        
        }else{ //Update
            db.execute("Update employee set CustName=? CustAddress=?,MobileNo=?,BirthDate=?,ACBalance=?where custno=?",custname,custaddress,mobile,bdate,acbal,custno);
    ...
    private void btndeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteActionPerformed
        ...
        if(i!=-1){
            ...
            if(ans==JOptionPane.YES_OPTION){
                String custno=table1.getValueAt(i, 0)+"";                
                db.execute("delete from employee where custno=?", custno);
                db.fillTable(table1, "SELECT * from employee");
            }
        }else{
