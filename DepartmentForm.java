...
public class DepartmentForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblimage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/company2.png"))); // NOI18N
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        if(btntext.equals("Save")){ //Insert
            ...
            Messages.showInfo("Department Information is Saved Successfully...", "Success");        
        }else{ //Update
            db.execute("Update Department set DepartmentName=? where DepartmentName=?",name,oldname);
            Messages.showInfo("Department Information is Updated Successfully...", "Success");        
        }
        db.fillTable(table1, "select * from Department");
